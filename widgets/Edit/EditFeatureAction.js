  ...
  var clazz = declare(BaseFeatureAction, {
    ...
    isFeatureSupported: function(featureSet, layerParam){
      ...
      */
      ...
      if(jimuLayerInfo && (jimuLayerInfo.isTable ? true : jimuLayerInfo.isShowInMap())) {
      ...
      layerIsEditableDef.then(lang.hitch(this, function(isEditableLayer) {
        ...
        } else if(editConfig.editor.layerInfos.length === 0 || editConfig.editor.honorSettingOfWebmap) {
